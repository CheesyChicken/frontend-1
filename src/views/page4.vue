        ...
        <nav class="mb-3">
          <b-nav vertical>
            <b-nav-item href="#link-1"
              ><router-link to="/director/home">Home</router-link></b-nav-item
            >
            <b-nav-item href="#link-2"
              ><router-link to="/director/allprojects"
                >All Projects</router-link
              ></b-nav-item
            >
           <!--  <b-nav-item href="#link-1"
              ><router-link to="/director/PD">Project Details</router-link></b-nav-item
            > -->
          </b-nav>
        </nav>
      </div>
